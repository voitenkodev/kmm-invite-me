...
fun Modifier.neu(
    ...
    override fun ContentDrawScope.draw() {
        if (pressed) drawForeground(lightSource, radius, shadow1, shadow2)
        else drawBackground(lightSource, radius, shadow1, shadow2)
        drawContent()
    }

    fun ContentDrawScope.drawBackground(
        lightSource: LightSource, radius: Dp, shadow1: Color, shadow2: Color
